...
这是一个适用于 **三星 Galaxy Z5 系列** 的高性能自定义内核。它旨在提供卓越的稳定性和流畅度，同时围绕当前仍在维护的 `LKM` 与 `ReSukiSU` 模式，带来更清晰也更稳定的玩机体验。
...
This is a high-performance custom kernel for the **Samsung Galaxy Z5 Series**. It is designed to deliver exceptional stability and smoothness while focusing on the currently maintained `LKM` and `ReSukiSU` modes.
